# -*- encoding: utf-8 -*-
# stub: actionview 6.0.0.beta3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.0.beta3/actionview/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.0.beta3/actionview" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<actionpack>.freeze, ["= 6.0.0.beta3"])
      s.add_development_dependency(%q<activemodel>.freeze, ["= 6.0.0.beta3"])
    else
